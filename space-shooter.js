...
function init() {
    try {
        ...
        '██║  ██║╚██████╔╝██║  ██║██║ ╚████║██║   ██║   ██║  ██║    ██║  ██╗\n' +
        '╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝   ╚═╝   ╚═╝  ╚═╝    ╚═╝  ╚═╝\n', 
        'color: #00ffff; font-weight: bold; font-size: 12px; font-family: monospace;');
        console.log('%c🚀 NEXUS STRIKE - A Three.js Space Shooter Experience', 'color: #00ff00; font-size: 14px; font-weight: bold;');
